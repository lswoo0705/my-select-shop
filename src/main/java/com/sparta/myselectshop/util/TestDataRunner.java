...
//
//@Component
//public class TestDataRunner implements ApplicationRunner { // 테스트용 더미객체 생성 쿼리 작성 코드
//
//    @Autowired
...
//        // 테스트 User 생성
//        User testUser = new User("asd", passwordEncoder.encode("123"), "asd@sparta.com", UserRoleEnum.USER);
